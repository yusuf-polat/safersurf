        ...
        >
            ...
            >
                ...
                <span class="mx-2 whitespace-nowrap overflow-hidden text-ellipsis">
                    {use(
                        this.cloakTitle,
                        (cloakedTitle) => cloakedTitle || "Safer Surf",
                    )}
                </span>
                <ChevronDown
            ...
            >
                <div class="flex flex-wrap gap-2">
                    ...
                    <button
                        class="flex justify-center items-center px-[1.125rem] h-10 rounded-xl select-none bg-Surface0"
                        aria-label="Gizleme Google Classroom"
                        on:click={() => (
                    ...
                    <button
                        class="flex justify-center items-center px-[1.125rem] h-10 rounded-xl select-none bg-Surface0"
                        aria-label="Gizleme Google Drive"
                        on:click={() => (
            ...
            <p class="select-none">Arama Motoru</p>
            <button
                class="flex items-center px-[1.125rem] h-10 rounded-xl select-none bg-Surface0 shrink-0"
                aria-label="Geçerli Arama Motoru"
            ...
            >
                ...
                <input
                    placeholder="Arama Motoru (%s = sorgu)"
            ...
            <p class="select-none">Tema</p>
            <button
                class="flex items-center px-[1.125rem] h-10 rounded-xl select-none bg-Surface0 shrink-0"
                aria-label="Geçerli Tema"
            ...
            >
                ...
                <span class="mx-2 whitespace-nowrap overflow-hidden text-ellipsis">
                    {use(
                        this.theme,
                        (theme) => themes[theme].title || "Geçersiz Tema",
                    )}
                </span>
                <ChevronDown
                    class="w-4 h-4 shrink-0 ml-auto"
