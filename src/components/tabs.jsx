    ...
    return (
        ...
        >
            <button
                ...
                aria-label="Yeni Sekme" // New Tab -> Yeni Sekme
                title={use`Yeni Sekme (${this.actionKey}+T)`} // New Tab -> Yeni Sekme
                ...
                {use(this.tabs, (tabs) =>
                    tabs.map((tab, index) => (
                        <button
                            ...
                            aria-label={"Sekme #" + String(index)} // Tab -> Sekme
                        ...
                        >
                            ...
                            <button
                                ...
                                aria-label={"Sekmeyi Kapat #" + String(index)} // Close tab -> Sekmeyi Kapat
                                title={use`Sekmeyi Kapat (${this.actionKey}+W)`} // Close Tab -> Sekmeyi Kapat
