...
const Home = function () {
    ...
    this.tabs = [
        {
            title: "Yeni Sekme", // New Tab -> Yeni Sekme 
        },
    ];
    this.current = 0;
    ...
    const newTab = async (title = "Yeni Sekme", url) => { // New Tab -> Yeni Sekme
            ...
            <div class="flex justify-center fixed bottom-0 right-0 left-0">
                <div class="flex items-center flex-1 gap-2 bg-Base rounded-[26px] p-1.5 my-2 mx-5 max-w-3xl shadow">
                    <button
                        ...
                        aria-label="Sekmeler Kenar Çubuğu" // Tabs Sidebar -> Sekmeler Kenar Çubuğu
                        title={use`Sekmeler (${this.actionKey}+A))`} // Tabs -> Sekmeler
                    ...
                    <button
                        ...
                        aria-label="Ayarlar Kenar Çubuğu" // Settings Sidebar -> Ayarlar Kenar Çubuğu
                        title={use`Ayarlar (${this.actionKey}+S)`} // Settings -> Ayarlar
                    ...
                    <input
                        ...
                        placeholder="Ara veya URL Yaz" // Search or Type URL -> Ara veya URL Yaz
                        class="flex-1 border-0 bg-transparent outline-none h-10 w-full placeholder:select-none placeholder:text-Subtext0"
                    />
                    <button
                        on:click={back}
                        aria-label="Geri" // Back -> Geri
                        title={use`Geri Git (${this.actionKey}+Sol)`} // Go Back -> Geri Git, Left -> Sol
                    ...
                    <button
                        on:click={forward}
                        aria-label="İleri" // Forward -> İleri
                        title={use`İleri Git (${this.actionKey}+Sağ)`} // Go Forward -> İleri Git, Right -> Sağ
                    ...
                    <button
                        on:click={reload}
                        aria-label="Yeniden Yükle" // Reload -> Yeniden Yükle
                        title={use`Yeniden Yükle (${this.actionKey}+R)`} // Reload -> Yeniden Yükle
